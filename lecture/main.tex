...
\begin{document}
    ...
    \chapter{Laws of Electrodynamics} % (fold)
    ...
    % chapter Laws of ELectrodynamics (end)

    \chapter{Electromagnetism in matter} % (fold)
    \label{cha:Electromagnetism in matter}
    
    % chapter Electromagnetism in matter (end)

    \chapter{Electromagnetic Waves} % (fold)
    ...
    % chapter Electromagnetic Waves (end)
\end{document}
